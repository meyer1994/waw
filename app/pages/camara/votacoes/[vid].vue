...
import type { CamaraItem, VotacaoDetalhe } from '#shared/api'
...
const { data } = await useFetch<CamaraItem<VotacaoDetalhe>>(`/api/camara/votacoes/${vid}`)
const votacao = computed(() => data.value?.dados)
